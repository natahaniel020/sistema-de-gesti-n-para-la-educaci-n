...
-- ──2 SELECT ALL ────────────────────────────────────────────────────
DROP PROCEDURE IF EXISTS sp_estudiante_obtener_todos
...
-- ──8  SELECT BY PK ──────────────────────────────────────────────────
DROP PROCEDURE IF EXISTS sp_profesor_obtener_por_id;
...
-- ──13 SELECT BY PK ──────────────────────────────────────────────────
DROP PROCEDURE IF EXISTS sp_asignatura_obtener_por_id $$
...
BEGIN
    SELECT
        ...
        requisitos_previos, bibliografia
    FROM asignatura
    WHERE codigo_asignatura = p_codigo_asignatura COLLATE utf8mb4_0900_ai_ci;
END $$
...
-- ──15 DELETE ────────────────────────────────────────────────────────
DROP PROCEDURE IF EXISTS sp_asignatura_eliminar $$

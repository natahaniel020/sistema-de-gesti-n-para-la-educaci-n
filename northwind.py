...
# FUNCIÓN GENÉRICA — construye formulario y botones

def construir_formulario(tab, titulo, color, campos):
    tk.Label(tab, text=titulo,
             font=("Arial", 14, "bold"), fg=color).pack(pady=10)
...
def construir_botones(tab):
    ...
    tk.Button(btn_frame, text="Guardar",    font=("Arial", 12),
              bg="#4CAF50", fg="white", width=10).pack(side=tk.TOP, padx=5)
    tk.Button(btn_frame, text="Actualizar", font=("Arial", 12),
              bg="#2196F3", fg="white", width=10).pack(side=tk.TOP, padx=5)
    tk.Button(btn_frame, text="Eliminar",   font=("Arial", 12),
              bg="#f44336", fg="white", width=10).pack(side=tk.TOP, padx=5)
    tk.Button(btn_frame, text="Limpiar",    font=("Arial", 12),
              bg="#FF9800", fg="white", width=10).pack(side=tk.TOP, padx=5)
